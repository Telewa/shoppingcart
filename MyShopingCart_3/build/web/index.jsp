...
<c:if test="${sessionScope.CurrentSessionUser.name != 'Admin' or sessionScope.CurrentSessionUser.name == null }" var="test">
    <c:url value="Admin.jsp" var="myURL">
...
<jsp:useBean id="common" class="controler.Common"></jsp:useBean>
                    ...
                    <fmt>
                        ...
                        <label id="itemPrice"> Ksh<c:out value="${row.price}"></c:out> </label><br>
                            ...
                            <sql:query dataSource="${name}" var="componentName">
                                SELECT * FROM `product_component`, component where componet_id=compnt_id and product_id="${row.product_id}";
                            </sql:query>
    ...
    <center>
        <table width="300" border="1" cellspacing="0" cellpadding="2" border="0" id="Cart">
            ...
            <tr style="font-size: x-large"><td>Total</td><td id="totalCost" >0</td><td></td><td><button id="buy_button"  disabled="true" name ="buy_button" class="buy_button" type="button" onclick="General.buttonBuyItems()">Buy</button></td></tr>
        </table>
    </center>
</body>
</html>

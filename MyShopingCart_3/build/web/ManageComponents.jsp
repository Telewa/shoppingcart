...
<html>
    ...
    <body>
        ...
        <div id="bodyContainer">
            ...
            <table>
                <tr> <td>component_id</td>  <td>Name</td> <td>number_of_units</td> <td>price_per_item</td> <td>description</td></tr>                    <sql:setDataSource var="name" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/shoppingcart" user="emma" password="#if!emma"/>
        ...
        <div id="bodyContainer">
            ...
            <select id="itemToAdd">
                ...
                <sql:setDataSource var="name" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/shoppingcart" user="emma" password="#if!emma"/>
                <sql:query dataSource="${name}" var="itemName">
